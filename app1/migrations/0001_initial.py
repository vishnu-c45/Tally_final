...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, default='Compound', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FormalName', models.CharField(blank=True, max_length=255, null=True)),
                ('ISOCurrency', models.CharField(blank=True, max_length=30, null=True)),
                ('DecimalPlace', models.IntegerField(blank=True, null=True)),
                ('showAmount', models.CharField(blank=True, max_length=20, null=True)),
                ('suffixSymbol', models.CharField(blank=True, max_length=20, null=True)),
                ('AddSpace', models.CharField(blank=True, max_length=20, null=True)),
                ('wordRep', models.CharField(blank=True, max_length=255, null=True)),
                ('DecimalWords', models.IntegerField(blank=True, null=True)),
                ('stddate', models.CharField(blank=True, max_length=255, null=True)),
                ('stdrate', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('sellrate', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('buyrate', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nature', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, default='Simple', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='Stock_Group_Creation_Model',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Name', models.CharField(max_length=30)),
                ('Alias', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            name='Stock_Item_Creation_Model',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Name', models.CharField(max_length=30)),
                ('Alias', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            name='Voucher_Type_Creation_Model',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Name', models.CharField(max_length=30)),
                ('Alias', models.CharField(blank=True, max_length=30, null=True)),
                ('STV', models.CharField(blank=True, max_length=30, null=True)),
                ('Abb', models.CharField(blank=True, max_length=30, null=True)),
                ...
                ('PVAS', models.CharField(blank=True, max_length=10, null=True)),
                ('NC', models.CharField(blank=True, max_length=40, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Vouchers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Voucher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.vouchers')),
            ],
        ),
        migrations.CreateModel(
            name='Voucher_count',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_for', models.CharField(max_length=225)),
                ('method', models.CharField(max_length=225)),
                ('maingroup', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.maingroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ledger_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app1.ledger')),
            ],
        ),
        migrations.CreateModel(
            name='payable',
        ...
        migrations.AddField(
            ...
            name='under',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.under'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subgroup', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.subgroup')),
            ],
        ),
        migrations.CreateModel(
            name='lcheque',
            fields=[
                ...
                ('ledger_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.ledger')),
            ],
        ),
        migrations.CreateModel(
            name='lbank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('M_count', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.maingroup')),
                ('S_count', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.subgroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Total', models.IntegerField(blank=True, default='', null=True)),
                ('Accounts', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.accounts')),
            ],
        ),
    ]
